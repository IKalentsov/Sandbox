...
public static class DependencyInjection
{
    ...
    )
    {
        ...
        if (string.IsNullOrWhiteSpace(connectionString))
        {
            ...
            {
                connectionString =
                    "Host=host.docker.internal;Port=5432;Database=Sandbox_v1;Username=postgres;Password=admin";
            }
            else
            {
        ...
        services.AddDbContextPool<SandboxDbContext>(
            ...
            poolSize: 128
        ); // Размер пула по умолчанию 128, можно изменить
