...
public class UserEntityConfigurations : IEntityTypeConfiguration<UserEntity>
{
    public void Configure(EntityTypeBuilder<UserEntity> builder)
    {
        ...
        builder.Property(u => u.Created).HasColumnName("created").IsRequired();

        builder.Property(u => u.Modified).HasColumnName("modified").IsRequired();
        ...
        builder.Property(u => u.Right).HasColumnName("right").IsRequired();
        ...
        builder.HasIndex(u => u.Login).IsUnique().HasDatabaseName("ix_users_login");
